...
Requires: expat2 = %{version}-%{release}
...
# allow for expat and expat2 side by side install
mv $RPM_BUILD_ROOT/%{_bindir}/xmlwf \
   $RPM_BUILD_ROOT/%{_bindir}/xmlwf2

mv $RPM_BUILD_ROOT/%{_mandir}/man1/xmlwf.1 \
   $RPM_BUILD_ROOT/%{_mandir}/man1/xmlwf2.1
...
%changelog
* Mon Nov 12 2012 Jeffrey Ness <jeffrey.ness@rackspace.com> - 2.0.1-1.ius
- Building expat 2.0.1 in IUS for Python 2.7

* Wed Jun 15 2011 Daniel Riek <daniel.riek@vincorex.ch> - 2.0.1-9.2vx
- Built as expat2 for Centos 5.
